...
def paywall_premium_text() -> str:
    return (
        ...
        "*12 разделов персонального досье:*\n"
        "• кто вы на самом деле\n"
        "• скрытые эмоции и страхи\n"
        "• любовь и почему не складываются отношения\n"
        "• деньги, карьера, предназначение\n"
        "• таланты, дети, жизненные уроки\n"
        "• итоговый портрет с рекомендациями\n\n"
        "💰 Стоимость: *249 ₽*\n"
